...
import com.wei.model.common.BaseDto;
import com.wei.model.valid.group.UserEditValidGroup;
import com.wei.model.valid.group.UserLoginValidGroup;
import com.wei.util.JedisUtil;
import com.wei.exception.CustomException;
import com.wei.exception.CustomUnauthorizedException;
import com.wei.model.UserDto;
import com.wei.model.common.Constant;
import com.wei.model.common.ResponseBean;
import com.wei.service.IUserService;
import com.wei.util.AesCipherUtil;
import com.wei.util.JwtUtil;
import com.wei.util.UserUtil;
import com.wei.util.common.StringUtil;
...
public class UserController {
     ...
     * @param 
     * @return com.wei.model.common.ResponseBean
     * @author Jiawei.Mao
     * @date 2019/06/07 9:58
     */
    @GetMapping("/online")
    @RequiresPermissions(logical = Logical.AND, value = {"user:view"})
